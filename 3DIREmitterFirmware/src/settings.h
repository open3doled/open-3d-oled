...
#define IR_DRIVE_MODE_RF_TRIGGER 3
...
// D14 (was D7)
#define DEBUG_AVERAGE_TIMING_MODE_RESYNC_D14 3
#define DDR_DEBUG_AVERAGE_TIMING_MODE_RESYNC_D14 DDRB
#define PORT_DEBUG_AVERAGE_TIMING_MODE_RESYNC_D14 PORTB
