...
*
* Version 0204a: added ability to add custom empty space on left side of main board for choke and other electronics
...
base_obm_wx = 6;
base_obm_px = base_wx+base_fww-base_bww-base_obm_wx;
base_obm_py = base_wy-base_ww-15;
base_obm_pdz = 6;
base_obma_wz = 3;
base_obma_wy = 6.5; // left side has 1.5mm less support due to opt101 throughhole pins sticking out
base_obmr_pdz = 3;
...
base_obmmh_px = base_wx+base_fww-base_bww-2;
base_obmmh_py = base_wy-base_ww-11; 
base_obmh_wx = 12;
base_obmh_wy = 12;
base_obmh_px = base_wx+base_fww-base_bww-12;
base_obmh_py = base_obmmh_py+9-base_obmh_wy+3.5;
base_md3d_wd_h = 3.1;
base_md3d_py = 13;
...
cover_esbh_px = 27;
cover_esbh_py = base_mmh_list[0][0]-5;
cover_esbhi_wd = 3.5;
...
module base() {
  difference() {
    ...
    if (include_dlplink_sensor) {
        translate([base_obm_px,base_obm_py,base_bwh+base_wz-base_obm_pdz-base_obma_wz])cube([base_obm_wx+ovr,base_obma_wy,base_obma_wz]);
   // opt board mount arm
        
        // opt board mount ramp
        hull() {
          translate([base_obm_px+base_obm_wx,base_obm_py,base_bwh+base_wz-base_obm_pdz-base_obmr_pdz-base_obma_wz+ovr])cube([base_bww,base_obma_wy,base_obma_wz]);
          translate([base_obm_px,base_obm_py,base_bwh+base_wz-base_obm_pdz-base_obma_wz])cube([base_obm_wx+ovr,base_obma_wy,ovr]); 
        }
      }
